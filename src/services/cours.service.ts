    ...
    forum : [
      {
        ...
        chat: [
          {
            auteur: "Arthur",
            message: "Pouvez vous m'aider? Merci!"
          },
          {
            auteur: "Bely",
            message: "Aucun problème, pour la fonction exp, c'est comme cela qu'il faut faire!"
          }
        ]
      }
    ]
    ...
    },
    {
      ...
      contenu: [
        ...
        },
        {
          class: "image",
          lien:
            "http://www.orseu-concours.com/206-343-thickbox/epso-numerical-reasoning-test-3-en.jpg"
        },
        {
          text:
            "Nemo quaeso miretur, si post exsudatos labores itinerum longos congestosque adfatim commeatus fiducia vestri ductante barbaricos pagos adventans velut mutato repente consilio ad placidiora deverti.",
